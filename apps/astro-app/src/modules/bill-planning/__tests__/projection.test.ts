...
describe("projectOccurrences", () => {
  it("unrolls a weekly bill across the window", () => {
  ...
  it("includes a monthly bill once and sorts by date", () => {
    const result = projectOccurrences(
      [
  ...
  it("rolls bills due before the window forward into it", () => {
    const result = projectOccurrences(
  ...
  it("excludes bills whose schedule never reaches the window", () => {
    const result = projectOccurrences(
